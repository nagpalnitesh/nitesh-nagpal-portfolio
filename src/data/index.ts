...
export const gridItems = [
  {
    id: 1,
    title:
      "A passionate full-stack developer dedicated to creating impactful digital experiences.",
    description: "",
  ...
  {
    id: 2,
    title: "Builiding intuitive, scalable applications.",
    description: "",
  ...
  {
    id: 4,
    title: "Driven by continuous learning and innovation.",
    description: "",
...

  {
    id: 5,
    title:
      "Working on a personal project to streamline health insights using AI and Flutter.",
    description: "Personalized AI-Driven Healthcare",
  ...
  {
    id: 6,
    title: "Want to build something amazing?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const projects = [
  {
    id: 1,
    title: "NN Photography",
    des: "This website serves as a platform to share my passion for wildlife and nature photography with the world. Through stunning imagery and captivating stories, I aim to inspire others to appreciate and protect the natural world around us.",
